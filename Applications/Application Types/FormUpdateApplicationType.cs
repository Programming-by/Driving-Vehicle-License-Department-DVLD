...
namespace DVLDWinForm
{
    public partial class FormUpdateApplicationType : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            _ApplicationTypesData.Title = txtTitle.Text.Trim();
            _ApplicationTypesData.Fees = Convert.ToSingle(txtFees.Text.Trim());


            if (_ApplicationTypesData.Save()) {
        ...
        private void FormUpdateApplicationType_Load(object sender, EventArgs e)
        {
            ...
            {
                txtTitle.Text = _ApplicationTypesData.Title;
                txtFees.Text = _ApplicationTypesData.Fees.ToString();
            }
        }
