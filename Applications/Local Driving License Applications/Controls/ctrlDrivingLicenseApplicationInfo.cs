...
namespace DVLDWinForm.Applications.Local_Driving_License_Applications.Controls
{
    public partial class ctrlDrivingLicenseApplicationInfo : UserControl
    {
        ...
        private void _FillLocalDrivingLicenseApplicationInfo()
        {
            ...
            lblAppliedFor.Text = clsLicenseClassData.Find(_LocalDrivingLicenseApplication.LicenseClassID).ClassName;
