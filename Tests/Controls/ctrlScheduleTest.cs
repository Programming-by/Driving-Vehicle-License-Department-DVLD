    ...
    public partial class ctrlScheduleTest : UserControl
    {
        ...
        private bool _HandleRetakeApplication()
        {
            if (_Mode == enMode.AddNew && _CreationMode == enCreationMode.RetakeTestSchedule)
            {
                ...
                Application.PaidFees = clsApplicationTypesData.Find((int)clsApplication.enApplicationType.RetakeTest).Fees;
        ...
        private bool _LoadTestAppointmentData()
        {
            ...
            //if user make date in past 10 days and in update it not reasonable to let him start from today date so i compare 
            //the lower and put it
